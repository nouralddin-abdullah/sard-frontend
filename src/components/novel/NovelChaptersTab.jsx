          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                <span
                  className={`noto-sans-arabic-medium text-base ${
                ...
                {isLastRead && (
                  <span className="text-xs bg-[#4A9EFF] text-white px-2 py-0.5 rounded noto-sans-arabic-medium">
                    آخر قراءة
                  </span>
                )}
              </div>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2">
                {canAccess ? (
                  <Unlock className="w-4 h-4 text-[#4A9EFF]" />
                ) : (
                  <Lock className="w-4 h-4 text-[#4A9EFF]" />
                )}
                <span className="noto-sans-arabic-medium text-base">{chapter.title}</span>
                <span
                  className={`text-xs px-2 py-0.5 rounded noto-sans-arabic-medium border ${
                    canAccess
