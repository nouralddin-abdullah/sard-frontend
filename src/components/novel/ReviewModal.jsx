...
const ReviewModal = ({ isOpen, onClose, novelTitle, novelId }) => {
  ...
  const ratingCategories = [
    { key: 'writingQuality', label: 'جودة الكتابة', apiKey: 'writingQualityScore' },
    { key: 'updateStability', label: 'استقرار التحديثات', apiKey: 'updatingStabilityScore' },
    { key: 'storyDevelopment', label: 'تطور القصة', apiKey: 'storyDevelopmentScore' },
    { key: 'characterDesign', label: 'بناء الشخصيات', apiKey: 'characterDevelopmentScore' },
    { key: 'worldBuilding', label: 'بناء العالم القصصي', apiKey: 'worldBuildingScore' }
  ];
      ...
      <div className="bg-[#2C2C2C] rounded-2xl w-full max-w-[1000px] max-h-[90vh] overflow-y-auto m-4 shadow-[0px_4px_4px_rgba(0,0,0,0.25)] scrollbar-hide [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-3">
            <label className="text-white noto-sans-arabic-extrabold text-[20px] block">
              شارك رأيك
            </label>
            <textarea
              value={reviewText}
